...
public:
    ...
    {
        searchCommit->setWindowTitle(QApplication::translate("searchCommit", "Dialog", Q_NULLPTR));
        label->setText(QApplication::translate("searchCommit", "Git Repository Website", Q_NULLPTR));
    } // retranslateUi
