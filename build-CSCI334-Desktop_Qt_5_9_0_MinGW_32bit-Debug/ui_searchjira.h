...
public:
    ...
    {
        searchJIRA->setWindowTitle(QApplication::translate("searchJIRA", "Dialog", Q_NULLPTR));
        label->setText(QApplication::translate("searchJIRA", "Search JIRA Project Name", Q_NULLPTR));
    } // retranslateUi
