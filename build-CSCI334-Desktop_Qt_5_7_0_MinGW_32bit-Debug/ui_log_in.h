...
public:
    ...
    void retranslateUi(QMainWindow *Log_in)
    {
        ...
        pushButton_4->setText(QApplication::translate("Log_in", "Exit", 0));
        lblresult->setText(QApplication::translate("Log_in", "[+]Status", 0));
        Login->setText(QApplication::translate("Log_in", "Login", 0));
        register_2->setText(QApplication::translate("Log_in", "Register", 0));
        label->setText(QApplication::translate("Log_in", "Username:", 0));
        label_2->setText(QApplication::translate("Log_in", "Password:", 0));
    } // retranslateUi
